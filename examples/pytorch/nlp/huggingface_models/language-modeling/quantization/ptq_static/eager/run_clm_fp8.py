...
parser.add_argument("--precision", default="fp8_e4m3",
                    help="Smooth quant parameter.")
parser.add_argument("--cast_e4m3", action="store_true")
parser.add_argument("--no_lm_head", action="store_true")
...
if args.quantize:
    ...
    os.environ['FP8_OP_TYPE_LIST'] = "['linear']"
    print("FP8_OP_TYPE_LIST=['linear']")
    if args.cast_e4m3:
        os.environ['E4M3_SCALE'] = '1'
        print('E4M3_SCALE=1')
    if args.no_lm_head:
        op_name_list = {
            ".*lm_head.*":
