...
This document is used to enable Tensorflow Keras model inception_resnet_v2 mix-precision and benchmark using Intel® Neural Compressor.
...
The Mix-precision Config class has default parameters setting for running on Intel CPUs. If running this example on Intel GPUs, the 'backend' parameter should be set to 'itex' and the 'device' parameter should be set to 'gpu'.
