...
if __name__ == '__main__':
    ...
    configs = [
        {  ## Example of a regular configuration
            ...
            'target_sparsity': 0.4,  # Target sparsity ratio of modules.
    ...
    optimizer = torch.optim.Adam(parameters, lr=5e-4, weight_decay=0)
    ...
    total_training_step = (training_step - 1) * prune_cnt
    ...
    for i in range(1, prune_cnt + 1):
        prune(model, calib_dataloader, prune_cnt=prune_cnt, completed_pruned_cnt=i, calib_cnt=1000)
